...
class EndlessWorld extends World with TapCallbacks, HasGameReference {
  ...
  // final PlayerProgressState playerProgress;
  ...
  static double _calculateSpeed(int level) => 420 + (level * 200);
}
